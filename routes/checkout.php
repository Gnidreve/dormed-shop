...
Route::patch('/cart/items/{product}/{variant?}', [CartController::class, 'update'])->name('cart.items.update');
Route::delete('/cart/items/{product}/{variant?}', [CartController::class, 'destroy'])->name('cart.items.destroy');
