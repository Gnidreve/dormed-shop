...
- [Interactive platform guide](https://docs.stripe.com/connect/interactive-platform-guide.md): Use an interactive guide to determine the right Connect account type and payment flow for your platform based on your requirements.
